                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex gap-4 flex-wrap">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="mod_inventario" value="1" id="mod_inventario" <?php echo strpos($taller['modulos'] ?? '', 'inventario') !== false ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="mod_inventario">Inventario</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="mod_finanzas" value="1" id="mod_finanzas" <?php echo strpos($taller['modulos'] ?? '', 'finanzas') !== false ? 'checked' : ''; ?>>
                                <label class="form-check-label" for="mod_finanzas">Finanzas</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="mod_tienda" value="1" id="mod_tienda" <?php echo strpos($taller['modulos'] ?? '', 'tienda') !== false ? 'checked' : ''; ?>>
