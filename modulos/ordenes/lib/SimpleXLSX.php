...
class SimpleXLSX
{
    ...
    public function value($cell)
    {
        ...
        switch ($dataType) {
            ...
            case 'e':
                ...
                break;
            case 'D':
                if (!empty($cell->v)) $value = $this->datetimeFormat ? gmdate($this->datetimeFormat, $this->unixstamp((float)$cell->v)) : (float)$cell->v;
                break;
            case 'd':
                if ((string)$cell->v !== '') $value = (string)$cell->v;
                break;
    ...
    {
        $sn = $this->sheetNames();
        return isset($sn[$worksheetIndex]) ? $sn[$worksheetIndex] : false;
    }
    ...
    public static function parseRichText($is = null)
    {
        ...
        elseif (isset($is->r)) {
            foreach ($is->r as $run) $value[] = (string)$run->t;
        }
