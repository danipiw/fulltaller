...
<head>
    ...
    <title>Lista de Módulos - FullTaller</title>
...
<nav class="nav-jb" style="padding:0;">
    <div style="display: flex; align-items: center; justify-content: space-between; width: 100%; padding: 0 0 0 0.25rem; position: relative;">
        ...
        <div class="nav-center" style="display: flex; align-items: center; justify-content: center; flex:1; text-align:center;">
            <span class="nav-brand" style="color:white;font-weight:800;font-size:2rem;line-height:1;letter-spacing:-1px;font-family:'Neuropol X','Segoe UI',Tahoma,Geneva,Verdana,sans-serif;"><i class="bi bi-box-seam"></i> Módulos</span>
        </div>
...
<div class="container mt-3">
    <h1 style="color:var(--jb-navy);font-size:1.5rem;"><i class="bi bi-box-seam"></i> Lista de Módulos</h1>
        ...
        <div class="row g-3">
            <div class="col-md-6">
                ...
                <select class="form-select" id="marcaSelect" onchange="cargarModelos()">
                    ...
                    <?php
                    $marcas = $conn->query("SELECT DISTINCT marca FROM modulos ORDER BY marca");
...
function cargarModelos() {
    ...
    fetch('buscar_modulos.php?marca=' + encodeURIComponent(marca))
        .then(r => r.json())
        .then(data => {
            modelosCache = {};
...
function seleccionarModulo(id) {
    ...
    document.getElementById('detalleTitulo').innerHTML = '<i class="bi bi-phone"></i> ' + m.marca + ' ' + m.modelo;
